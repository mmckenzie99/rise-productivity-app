...
export const EMPTY={title:'',description:'',presentation_description:'',presentation_type:[],start_date:'',deploy_date:'',speaking_date:'',end_date:'',start_time:'',end_time:'',timezone:detectTimezone(),status:'Planning',progress:'Not Started',speaker_name:'Marshall McKenzie',speaker_bio:'',speaker_photo:'',presentation_file_url:'',handout_url:'',address:'',latitude:'',longitude:'',notes:'',attachments:[]};
...
export const planDateKeys=(ev)=>{
  ...
  let end=ev.end_date?new Date(`${ev.end_date}T00:00:00`):null;
  if(!end||end<start)return [ev.date];
