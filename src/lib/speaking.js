...
export const statusTone={Planning:'bg-[#FBF0D0] text-[#8A6A00]',Confirmed:'bg-[#E8EBF2] text-[#1B2A4B]',Completed:'bg-[#E8EAF0] text-[#5A6781]'};export const eventTone={Personal:'bg-[#EDE3F8] text-[#5B2DA0]',Work:'bg-[#DCEAF5] text-[#1B4A6B]'};export const calPlanTone='bg-[#D7F0DD] text-[#1E6B3A]';export const calEngagementTone='bg-[#FBE3C8] text-[#8A4B0E]';
