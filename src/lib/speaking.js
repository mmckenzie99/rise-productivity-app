...
export const EMPTY={title:'',description:'',presentation_type:[],start_date:'',speaking_date:'',start_time:'',end_time:'',timezone:detectTimezone(),status:'Planning',progress:'Not Started',speaker_name:'Marshall McKenzie',speaker_bio:'',speaker_photo:'',address:'',latitude:'',longitude:'',notes:'',attachments:[]};
