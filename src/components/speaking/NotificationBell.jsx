    ...
    <Popover>
      <PopoverTrigger asChild>
        {trigger ? trigger({ unreadCount }) : (
          <Button variant="ghost" size="icon" className="relative h-11 w-11 lg:h-9 lg:w-9 text-foreground hover:bg-accent" aria-label="Notifications">
      ...
      <PopoverContent align="end" side={side} className="w-80 p-0 bg-white text-[#1B2A4B]">
